...
public class ContentSettingsTests : IntegrationTestBase<Program> {
    ...
    // private async Task RunAssertionsAsync(ContentCheckBase<PropertyDetails> check) {
    //     await Task.Run(() => {
    //         Assert.Multiple(async () => {
    //             foreach (var documentType in _contentTypes) {
    ...
    //                     Console.WriteLine($"Validating property '{propertyDetails.Property.Name}' on document type '{propertyDetails.DocumentTypeName}'...");
